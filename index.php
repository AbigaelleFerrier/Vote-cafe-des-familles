...
<html lang="fr">
  ...
  <body class="vh-100">
    ...
    <div class="d-flex text-align justify-content-center mb-5">
        <a class="mx-2" style="color:white;" href="https://github.com/AbigaelleFerrier/Vote-cafe-des-familles">Code source</a>
        <a class="mx-2" style="color:white;" href="/vote.csv">Fichier de vote</a>
    </div>
